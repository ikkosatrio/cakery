...
class ShopOtherController extends Controller
{
    public function index(Request $request)
    {
        ...
        $data['cart'] = \Cart::session($member_id)->getContent();
        ...
        return view("user/shop-other",compact('data'));
    }
    ...
    public function checkout()
    {
        ...
        // dd($data);
        return view("user/checkout-other",compact('data'));
    ...
    public function addtocart(Request $request)
    {
        ...
        // dd($data);
        \Cart::session($member_id)->add($data);
