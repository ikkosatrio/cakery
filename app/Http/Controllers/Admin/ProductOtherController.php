...
class ProductOtherController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['data'] = Product::where(['type' => 2])->get()->sortByDesc('id');

        return view("admin/product-other/index",compact('data'));
    }
    ...
    public function create()
    {
        ...
        return view("admin/product-other/form",compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->file('image')) {
            ...
            $myFile = $this->img_location.'product-other/'.$data->image;
