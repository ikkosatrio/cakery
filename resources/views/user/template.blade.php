...
<head>
    ...
    <!-- Stylesheets -->
    <link href="{{ url('public/assets/user') }}/css/bootstrap.css" rel="stylesheet">
    <link href="{{ url('public/assets/user') }}/plugins/revolution/css/settings.css" rel="stylesheet" type="text/css">
    <!-- REVOLUTION SETTINGS STYLES -->
    <link href="{{ url('public/assets/user') }}/plugins/revolution/css/layers.css" rel="stylesheet" type="text/css">
    <!-- REVOLUTION LAYERS STYLES -->
    <link href="{{ url('public/assets/user') }}/plugins/revolution/css/navigation.css" rel="stylesheet" type="text/css">
    ...
    <!--[if lt IE 9]><script src="{{ url('public/assets/user') }}/https://cdnjs.cloudflare.com/ajax/libs/html5shiv/3.7.3/html5shiv.js"></script><![endif]-->
    <!--[if lt IE 9]><script src="{{ url('public/assets/user') }}/js/respond.js"></script><![endif]-->
    <script src="{{ url('public/assets/user') }}/js/jquery.js"></script>
...
<body>
        ...
        <header class="main-header">
            ...
            <div class="main-box">
                <div class="menu-box">
                    <div class="logo">
                        <a href="{{route('index')}}">
                            <img src="{{$config->LogoPath}}" style="width: 185px;border-radius: 10px 10px 10px 10px;" alt="" title="">
                        </a>
                    </div>
                        ...
                        <nav class="main-menu navbar-expand-md navbar-light">
                            <div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
                                <ul class="navigation menu-left clearfix">
                                    <li class="{{Request::is('/') ? 'current' : ''}}"><a href="{{route('index')}}">Gallery</a></li>
                                    <li class="{{Request::is('cakemenu*') ? 'current' : ''}}"><a href="{{route('cakemenu')}}">Cake Menu</a></li>
                                    <li class="{{Request::is('confection*') ? 'current' : ''}}"><a href="{{route('confection')}}">Confection</a></li>
                                </ul>
                                ...
                                <div class="shopping-cart">
                                    <ul class="shopping-cart-items">
                                        <li class="cart-item">
                                            ...
                                            <a href="{{ url('public/assets/user') }}/shop-single.html"
                                                class="product-detail"></a>
                                            <button class="remove-item"><span class="fa fa-times"></span></button>
                                        </li>

                                        <li class="cart-item">
                                            <img src="{{ url('public/assets/user') }}/https://via.placeholder.com/300x300"
                                                alt="#" class="thumb" />
                                    ...
                                    <div class="cart-footer">
                                        ...
                                        <a href="{{ url('public/assets/user') }}/cart.html" class="theme-btn">View
                                            Cart</a>
            ...
            <div class="sticky-header">
                <div class="auto-container clearfix">
                    <!--Logo-->
                    <div class="logo">
                        <a href="{{route("index")}}" title="Sticky Logo">
            ...
            <div class="mobile-header">
                <div class="logo"><a href="{{ url('public/assets/user') }}/index.html"><img
                            src="{{ url('public/assets/user') }}/images/logo-small.png" alt="" title=""></a></div>
            ...
            <div class="mobile-menu">
                <nav class="menu-box">
                    <div class="nav-logo"><a href="{{ url('public/assets/user') }}/index.html"><img
                                src="{{ url('public/assets/user') }}/images/logo-small.png" alt="" title=""></a></div>
                        ...
                        <div class="footer-column col-lg-4 col-md-12 col-sm-12">
                            <div class="footer-widget social-widget">
                                ...
                                <ul class="social-icon-one">
                                    <li><a href="{{$profile->social_facebook}}"><i class="fab fa-facebook-f"></i>
                                    ...
                                    <li><a href="{{$profile->social_twitter}}"><i class="fab fa-twitter"></i>
                                            <svg viewBox="0 0 850.4 850.4">
                                                <path class="st0"
                                                    d="M825.8,466.7L825.8,466.7l3-0.9l-3.3,0.8c-3.9-14.6-7.7-28.4-7.7-41.1c0-13.5,3.9-27.7,7.9-42.8 c5.9-21.9,11.9-44.5,6.1-66.3c-6-22.2-22.6-38.8-38.8-54.8c-11-10.9-21.3-21.2-27.8-32.6c-6.6-11.4-10.3-25.5-14.3-40.5 c-5.8-22.1-11.8-44.9-28-61.1c-15.9-16-38.5-22.1-60.4-27.8c-15-4-29.3-7.8-40.9-14.5c-11-6.4-21-16.5-31.7-27.3 c-16.3-16.4-32.9-33.2-55.7-39.4c-22.7-6.1-45.7,0.2-67.8,6.2c-14.6,3.9-28.4,7.7-41,7.7c-13.5,0-27.7-3.9-42.8-7.9 C366.9,20.3,351,16,335.2,16c-6.4,0-12.7,0.7-19,2.4c-22.2,6-38.7,22.6-54.8,38.8c-10.9,11-21.2,21.3-32.6,27.8 s-25.4,10.3-40.4,14.3c-22.1,5.9-44.8,11.8-61,28.1c-16,16-22,38.5-27.8,60.5c-4,15.1-7.8,29.4-14.5,41 c-6.4,11-16.5,21.1-27.3,31.8c-16.4,16.2-33.2,32.9-39.3,55.8c-6.1,22.7,0.2,45.8,6.2,68c3.9,14.6,7.7,28.4,7.7,41.1 c0,13.5-3.9,27.6-7.9,42.8c-5.9,22-11.9,44.6-6.1,66.4c6,22.2,22.6,38.8,38.8,54.9c11,10.9,21.3,21.2,27.8,32.6 c6.6,11.4,10.3,25.4,14.3,40.4c5.9,22.2,11.8,44.9,28,61.2c16,16,38.5,22.1,60.4,27.8c15.1,4,29.3,7.9,40.9,14.5 c11,6.4,21,16.5,31.7,27.2c16.3,16.4,33,33.3,55.8,39.4c6.3,1.6,12.8,2.5,19.7,2.5c16.1,0,32.3-4.4,48-8.7 c14.7-4,28.5-7.8,41.1-7.8c13.5,0,27.6,3.9,42.7,7.9c22,5.9,44.5,11.9,66.3,6.2c22.2-6,38.7-22.7,54.8-38.9 c10.9-11,21.2-21.3,32.5-27.8c11.4-6.5,25.4-10.3,40.3-14.3c22.2-5.9,44.9-11.9,61.1-28.1c16-15.9,22-38.5,27.8-60.5 c4-15.1,7.9-29.4,14.5-41c6.4-11,16.4-21,27.1-31.7c16.4-16.3,33.5-33,39.6-55.9C838,511.9,835.8,488.9,825.8,466.7z">
                                                </path>
                                    ...
                                    <li><a href="{{$profile->social_instagram}}"><i class="fab fa-instagram"></i>
                                            <svg viewBox="0 0 850.4 850.4">
                                                <path class="st0"
                                                    d="M825.8,466.7L825.8,466.7l3-0.9l-3.3,0.8c-3.9-14.6-7.7-28.4-7.7-41.1c0-13.5,3.9-27.7,7.9-42.8 c5.9-21.9,11.9-44.5,6.1-66.3c-6-22.2-22.6-38.8-38.8-54.8c-11-10.9-21.3-21.2-27.8-32.6c-6.6-11.4-10.3-25.5-14.3-40.5 c-5.8-22.1-11.8-44.9-28-61.1c-15.9-16-38.5-22.1-60.4-27.8c-15-4-29.3-7.8-40.9-14.5c-11-6.4-21-16.5-31.7-27.3 c-16.3-16.4-32.9-33.2-55.7-39.4c-22.7-6.1-45.7,0.2-67.8,6.2c-14.6,3.9-28.4,7.7-41,7.7c-13.5,0-27.7-3.9-42.8-7.9 C366.9,20.3,351,16,335.2,16c-6.4,0-12.7,0.7-19,2.4c-22.2,6-38.7,22.6-54.8,38.8c-10.9,11-21.2,21.3-32.6,27.8 s-25.4,10.3-40.4,14.3c-22.1,5.9-44.8,11.8-61,28.1c-16,16-22,38.5-27.8,60.5c-4,15.1-7.8,29.4-14.5,41 c-6.4,11-16.5,21.1-27.3,31.8c-16.4,16.2-33.2,32.9-39.3,55.8c-6.1,22.7,0.2,45.8,6.2,68c3.9,14.6,7.7,28.4,7.7,41.1 c0,13.5-3.9,27.6-7.9,42.8c-5.9,22-11.9,44.6-6.1,66.4c6,22.2,22.6,38.8,38.8,54.9c11,10.9,21.3,21.2,27.8,32.6 c6.6,11.4,10.3,25.4,14.3,40.4c5.9,22.2,11.8,44.9,28,61.2c16,16,38.5,22.1,60.4,27.8c15.1,4,29.3,7.9,40.9,14.5 c11,6.4,21,16.5,31.7,27.2c16.3,16.4,33,33.3,55.8,39.4c6.3,1.6,12.8,2.5,19.7,2.5c16.1,0,32.3-4.4,48-8.7 c14.7-4,28.5-7.8,41.1-7.8c13.5,0,27.6,3.9,42.7,7.9c22,5.9,44.5,11.9,66.3,6.2c22.2-6,38.7-22.7,54.8-38.9 c10.9-11,21.2-21.3,32.5-27.8c11.4-6.5,25.4-10.3,40.3-14.3c22.2-5.9,44.9-11.9,61.1-28.1c16-15.9,22-38.5,27.8-60.5 c4-15.1,7.9-29.4,14.5-41c6.4-11,16.4-21,27.1-31.7c16.4-16.3,33.5-33,39.6-55.9C838,511.9,835.8,488.9,825.8,466.7z">
                                                </path>
                                    ...
                                    <li><a href="{{$profile->social_wa}}"><i class="fab fa-whatsapp"></i>
                                        <svg viewBox="0 0 850.4 850.4">
                                            <path class="st0"
                                                d="M825.8,466.7L825.8,466.7l3-0.9l-3.3,0.8c-3.9-14.6-7.7-28.4-7.7-41.1c0-13.5,3.9-27.7,7.9-42.8 c5.9-21.9,11.9-44.5,6.1-66.3c-6-22.2-22.6-38.8-38.8-54.8c-11-10.9-21.3-21.2-27.8-32.6c-6.6-11.4-10.3-25.5-14.3-40.5 c-5.8-22.1-11.8-44.9-28-61.1c-15.9-16-38.5-22.1-60.4-27.8c-15-4-29.3-7.8-40.9-14.5c-11-6.4-21-16.5-31.7-27.3 c-16.3-16.4-32.9-33.2-55.7-39.4c-22.7-6.1-45.7,0.2-67.8,6.2c-14.6,3.9-28.4,7.7-41,7.7c-13.5,0-27.7-3.9-42.8-7.9 C366.9,20.3,351,16,335.2,16c-6.4,0-12.7,0.7-19,2.4c-22.2,6-38.7,22.6-54.8,38.8c-10.9,11-21.2,21.3-32.6,27.8 s-25.4,10.3-40.4,14.3c-22.1,5.9-44.8,11.8-61,28.1c-16,16-22,38.5-27.8,60.5c-4,15.1-7.8,29.4-14.5,41 c-6.4,11-16.5,21.1-27.3,31.8c-16.4,16.2-33.2,32.9-39.3,55.8c-6.1,22.7,0.2,45.8,6.2,68c3.9,14.6,7.7,28.4,7.7,41.1 c0,13.5-3.9,27.6-7.9,42.8c-5.9,22-11.9,44.6-6.1,66.4c6,22.2,22.6,38.8,38.8,54.9c11,10.9,21.3,21.2,27.8,32.6 c6.6,11.4,10.3,25.4,14.3,40.4c5.9,22.2,11.8,44.9,28,61.2c16,16,38.5,22.1,60.4,27.8c15.1,4,29.3,7.9,40.9,14.5 c11,6.4,21,16.5,31.7,27.2c16.3,16.4,33,33.3,55.8,39.4c6.3,1.6,12.8,2.5,19.7,2.5c16.1,0,32.3-4.4,48-8.7 c14.7-4,28.5-7.8,41.1-7.8c13.5,0,27.6,3.9,42.7,7.9c22,5.9,44.5,11.9,66.3,6.2c22.2-6,38.7-22.7,54.8-38.9 c10.9-11,21.2-21.3,32.5-27.8c11.4-6.5,25.4-10.3,40.3-14.3c22.2-5.9,44.9-11.9,61.1-28.1c16-15.9,22-38.5,27.8-60.5 c4-15.1,7.9-29.4,14.5-41c6.4-11,16.4-21,27.1-31.7c16.4-16.3,33.5-33,39.6-55.9C838,511.9,835.8,488.9,825.8,466.7z">
                                            </path>
                        ...
                        <div class="footer-column col-lg-4 col-md-12 col-sm-12">
                            ...
                            <div class="footer-widget logo-widget">
                                <figure class="footer-logo"><img
                                        src="{{$config->LogoPath}}" style="max-height: 300px;" alt=""></figure>
                            </div>
                        </div>
    ...
    <script src="{{ url('public/assets/user') }}/js/popper.min.js"></script>
    <script src="{{ url('public/assets/user') }}/js/bootstrap.min.js"></script>
    <!--Revolution Slider-->
    <script src="{{ url('public/assets/user') }}/plugins/revolution/js/jquery.themepunch.revolution.min.js"></script>
    <script src="{{ url('public/assets/user') }}/plugins/revolution/js/jquery.themepunch.tools.min.js"></script>
    <script src="{{ url('public/assets/user') }}/plugins/revolution/js/extensions/revolution.extension.actions.min.js">
    </script>
    <script src="{{ url('public/assets/user') }}/plugins/revolution/js/extensions/revolution.extension.carousel.min.js">
    </script>
    <script src="{{ url('public/assets/user') }}/plugins/revolution/js/extensions/revolution.extension.kenburn.min.js">
    </script>
    <script
        src="{{ url('public/assets/user') }}/plugins/revolution/js/extensions/revolution.extension.layeranimation.min.js">
    </script>
    <script
        src="{{ url('public/assets/user') }}/plugins/revolution/js/extensions/revolution.extension.migration.min.js">
    </script>
    <script
        src="{{ url('public/assets/user') }}/plugins/revolution/js/extensions/revolution.extension.navigation.min.js">
    </script>
    <script src="{{ url('public/assets/user') }}/plugins/revolution/js/extensions/revolution.extension.parallax.min.js">
    </script>
    <script
        src="{{ url('public/assets/user') }}/plugins/revolution/js/extensions/revolution.extension.slideanims.min.js">
    </script>
    <script src="{{ url('public/assets/user') }}/plugins/revolution/js/extensions/revolution.extension.video.min.js">
    </script>
    <script src="{{ url('public/assets/user') }}/js/main-slider-script.js"></script>
    <!--Revolution Slider-->
    ...
    <script src="{{ url('public/assets/user') }}/js/owl.js"></script>
    <script src="{{ url('public/assets/user') }}/js/wow.js"></script>
    <script src="{{ url('public/assets/user') }}/js/appear.js"></script>
    <script src="{{ url('public/assets/user') }}/js/script.js"></script>
</body>
