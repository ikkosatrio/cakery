        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="formInput" action="{{ ($data['typeForm'] =="create") ? route('admin.shippingfee.store') : route('admin.shippingfee.update',$data['dataModel']->id) }}" method="POST" enctype="multipart/form-data">
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2">Post Code</label>
                                    <div class="col-lg-10">
                                        <input type="text" required class="form-control" value="{{ ($data['typeForm'] =="create") ? "" : $data['dataModel']->postcode }}" placeholder="Post Code" name="postcode">
                                    </div>
                                </div>
                                <div class="form-group row">
