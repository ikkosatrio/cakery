                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ ($typeForm =="create") ? "" : route('admin.confection.update',$dataModel->id) }}" id="formInput" enctype="multipart/form-data" action="post">
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-2">Content</label>
                                        <div class="col-lg-10">
                                            <textarea id="editor1" rows="3" cols="3" class="form-control" name="content" placeholder="Content">{{ ($typeForm =="create") ? "" : $dataModel->content }}</textarea>
                                        </div>
                                    </div>
