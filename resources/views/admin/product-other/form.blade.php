        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="formInput" action="{{ ($data['typeForm'] =="create") ? route('admin.product-other.store') : route('admin.product-other.update',$data['dataModel']->id) }}" method="POST" enctype="multipart/form-data">
