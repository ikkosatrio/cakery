                                    ...
                                    <div style="width: 100% !important;">
                                        ...
                                        <div
                                            ...
                                            <table id="u_content_image_1" style="font-family:'Open Sans',sans-serif;"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:31px 10px 25px;font-family:'Open Sans',sans-serif;"
                                                            align="left">
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:13px 26px 16px;font-family:'Open Sans',sans-serif;"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 14px; line-height: 19.6px;">{{$config->name}}</span>
                                                                </p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Open Sans',sans-serif;"
                                                            ...
                                                            <div class="v-text-align"
                                                                style="color: #615e5e; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 14px; line-height: 19.6px;">{{$item->product_name}}  ({{$item->quantity}} x {{number_format($item->product_price,2)}})</span></p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Open Sans',sans-serif;"
                                                            ...
                                                            <div class="v-text-align"
                                                                style="color: #615e5e; line-height: 140%; text-align: right; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 14px; line-height: 19.6px;">{{number_format($item->product_price*$item->quantity,2)}}</span>
                                                                </p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Open Sans',sans-serif;"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                    <strong><span
                                                                            style="font-size: 14px; line-height: 19.6px;">Pickup
                                                                            Addresss:</span></strong></p>
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 14px; line-height: 19.6px;">{{$profile->address}}&nbsp;
                                                                    </span></p>
                                                            </div>
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 24px; line-height: 33.6px;"><strong><span
                                                                                style="line-height: 33.6px; font-size: 24px;">Status Order</span></strong></span>
                                                                                <br>
                                                                <span>click this button to confirm</span>
                                                                </p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:35px 10px 10px;font-family:'Open Sans',sans-serif;"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                    <strong><span
                                                                            style="font-size: 30px; line-height: 42px;">{{$config->name}}</span></strong>
                                                                </p>
                                                            </div>
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:2px 40px 15px;font-family:'Open Sans',sans-serif;"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p
                                                                    style="font-size: 14px; line-height: 170%; text-align: center;">
                                                                    <em><span
                                                                            style="font-size: 14px; line-height: 23.8px;">{{$config->description}}&nbsp;
                                                                        </span></em></p>
                                                            </div>
